...
import "../contracts/MoonLendFactory.sol";
...
contract LendingPoolTest is Test {
    ...
    function setUp() public {
        ...
        factory = new MoonLendFactory(lendingPoolImplementation);
    ...
    function test_LiquidationOfExpiredLoans() public {
        ...
        MoonLendFactory.LoanRepayment[]
            memory loanInfos = new MoonLendFactory.LoanRepayment[](1);
    ...
    function test_RepayMulitplePools() public {
        ...
        MoonLendFactory.LoanRepayment[]
            memory loanInfos = new MoonLendFactory.LoanRepayment[](2);
        loanInfos[0] = _generateLoanRepayment(
        ...
        loanInfos[1] = MoonLendFactory.LoanRepayment(
    ...
    function _generateLoanRepayment(LendingPool.Loan memory loan)
        private
        view
        returns (MoonLendFactory.LoanRepayment memory)
    {
        LendingPool.Loan[] memory loans = new LendingPool.Loan[](1);
        loans[0] = loan;
        return MoonLendFactory.LoanRepayment(address(lendingPool), loans);
    }
