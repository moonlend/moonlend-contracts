...
describe("LendingPool", function () {
    ...
    it("returns a correct tokenURI", async function () {
        ...
        expect(await this.lendingPool.tokenURI(id)).to.eq(`https://nft.moonlend.app/nft/31337/${this.lendingPool.address.toLowerCase()}/${this.nft.address.toLowerCase()}/${id.toString()}`)
    });
